...
SECRET_KEY = 'django-insecure-1t6fj()ecs#36eb-ioj8nu$wo3+e0#s@idb-z!^%k8@)%c-n(8'
...
ALLOWED_HOSTS = [
    "localhost",
    "lion-lb-18904315-29182b3d15c6.kr.lb.naverncp.com",
    # LOCAL_IP,
]

CSRF_TRUSTED_ORIGINS = [
    "http://localhost:8888",
    "http://lion-lb-18904315-29182b3d15c6.kr.lb.naverncp.com",
